            ...
            <div class="section animated-row" data-section="slide01">
                <div class="section-inner">
                    <div class="welcome-box">
                        ...
                        <h1 class="welcome-title animate" data-animate="fadeInUp">杨昊</h1>
                        <p class="animate" data-animate="fadeInUp">你什么时候改简历</p>
                ...
                <div class="section-inner">
                    <div class="row justify-content-center">
                        <div class="col-md-7 wide-col-laptop">
                            ...
                            <div>More Templates <a href="" target="_blank" title="模板之家">xxx</a> - Collect from <a href="" title="网页模板" target="_blank">xxx</a></div>
                        </div>
                    </div>
                </div>
            </div>
